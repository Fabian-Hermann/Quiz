...
$Fragen = @(
	...
	@{ Typ = "MultipleChoice"; Kategorie = "PowerShell"; Prompt = "Was macht eine for-Schleife typischerweise?"; Antworten = @("Sie verarbeitet eine festgelegte bzw. kontrollierte Anzahl von Durchläufen", "Sie definiert eine Funktion", "Sie liest Benutzereingaben", "Sie lädt ein Modul"); RichtigeAntwort = 1 },
